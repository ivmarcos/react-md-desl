...
module.exports = {
  ...
  entry: {
    ...
    //vendor: ['react', 'react-md', 'redux', 'react-router-dom']
  },
  output: {
    // The build folder.
    path: paths.appBuild,
  ...
  module: {
    ...
    */
    loaders: [
      ...
      {
        test: /\.scss$/,
        loader: ExtractTextPlugin.extract('style', 'css?importLoaders=1!sass!postcss', extractTextPluginOptions),
  ...
  plugins: [
    ...
    new webpack.optimize.CommonsChunkPlugin('vendor', 'static/js/vendor.[chunkhash:6].min.js'),
